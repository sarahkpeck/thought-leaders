...
(function($){
    ...
    $(document).ready(function(){
        ...
        win.bind('beforeunload', function (e) {
            if (OptimizePress.disable_alert === false) {
    ...
    function init_child_elements(){
            ...
            $.post(OptimizePress.ajaxurl,
                {
                    ...
                    _wpnonce: $('#_wpnonce').val(),
                    shortcode: isPopup ? cur_child.html() || cur_child.val() : cur_child.val(),
                    // shortcode: cur_child.html() || cur_child.val(),
        ...
        $('#op_child_elements_form').submit(function(e){
            ...
            if (popupElement) {
                ...
                cur_child.closest('.element-container').find('.op-le-child-shortcode').val(popupElements).html(popupElements);
