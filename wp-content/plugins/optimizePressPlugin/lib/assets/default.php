            ...
            case 2:
                $html = '
                    <li>'
                        . $href_start
                            . '<div>
                                <span class="feature-block-2-img-container"><img class="feature-block-2" src="'.$image_source.'" /></span>'
                                . $h2_html
                                . op_texturize(do_shortcode(op_clean_shortcode_content($content))).'
                            </div>'
                        . $href_end
            ...
            case 3:
                $html = '
                    <li>'
                        . $href_start
                            . '<div>
                                <span class="feature-block-3-img-container" style="background-color: '.$bg_color.';"><img class="feature-block-3" src="'.$image_source.'" /></span>'
                                . $h2_html
                                . op_texturize(do_shortcode(op_clean_shortcode_content($content))).'
                            </div>'
                        . $href_end
            ...
            case 4:
                $html = '
                    <li>'
                        . $href_start
                            . '<div>
                                <span class="feature-block-4-img-container" style="background-color: '.$bg_color.';"><img class="feature-block-4" src="'.$image_source.'" /></span>'
                                . $h2_html
                                . op_texturize(do_shortcode(op_clean_shortcode_content($content))).'
                            </div>'
                        . $href_end
        ...
        switch ($gateway) {
            ...
            case 'stripe':
                ...
                if (defined('OP_LIVEEDITOR')) {
                    ...
                    $output = '[optimizeMember-Pro-Stripe-Form level="'.$level.'" ccaps="' . $ccaps . '" desc="'.$description.'" ps="paypal" lc="" cc="'.$currency_new.'" dg="0" ns="1" custom="'.$domain.'" ta="'.$at.'" tp="'.$first.'" tt="'.$days.'" ra="'.$want_to_charge.'" rp="'.$temp[0].'" rt="'.$temp[1].'" rr="'.$temp[2].'" coupon="" accept_coupons="0" default_country_code="US" captcha="0"]' . do_shortcode($content) . '[/optimizeMember-Pro-Stripe-Form]';
                }
            break;
            case 'clickbank':
